...
const buildTidecrestDocument: any = () => "";
const buildMeridianDocument: any = () => "";
const buildAsciiFieldDocument: any = () => "";
const buildBetawiseGlobeDocument: any = () => "";
...
const buildNocturneDocument: any = () => "";
...
export function applyBackgroundPresentation(
  ...
  if (targetHead) {
    targetHead.appendChild(presentationStyle);
  }
